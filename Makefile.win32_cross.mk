#
# Classic Reverb RE-03 Makefile
#
# This Makefile is designed to automate the build and packaging process for the Classic Reverb RE-03 project.
...
PROJECT_VERSION = $(shell sed -n 's/^project\s*([^)]*VERSION \([0-9.]*\).*/\1/p' CMakeLists.txt)
