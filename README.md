# Classic Reverb RE-03

Classic Reverb RE-03 is a reversed engineering of Kjaerhus Classic Reverb, a studio-quality free reverb plugin. It is a variant of [Classic Reverb RE-04](https://github.com/AnClark/ClassicReverb-RE04), with a different flavor of sound style and controls.
...
![Screenshot of Classic Reverb RE-03](Screenshot.png)
...
What's different from original Classic Reverb and [RE-04](https://github.com/AnClark/ClassicReverb-RE04):
...
To compile the Classic Reverb RE-03 plugin, you will need to have the following dependencies installed:
...
1. Clone the repository:
   ...
   ```bash
   git clone --recurse-submodules https://github.com/AnClark/ClassicReverb-RE03.git
   cd ClassicReverb-RE03
   ```
...
Classic Reverb RE-03 uses CMake for building and CPack for packaging. The package format is selected automatically for the target platform:
...
The `Makefile.win32_cross.mk` pipeline cross-compiles RE-03 for Windows and delegates packaging to CPack:
